...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/private_pub.yml', '.env', 'config/private_pub_thin.yml', 'tmp/searchd.pid', 'config/production.sphinx.conf')
